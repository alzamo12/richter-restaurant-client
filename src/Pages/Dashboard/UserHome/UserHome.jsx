...
const UserHome = () => {
    ...
    return (
        <div className='mx-10 mt-16'>
            ...
            {/* user stats section */}
            <div className="stats  flex  gap-10 mt-7">
            ...
            <div className='w-full h-[55vh] flex mt-10 '>
                <div className='w-1/2 h-full bg-[#FFEDD5] border-r-4 border-r-[#D1A054] flex flex-col justify-center items-center space-y-10'>
                    <div className='avatar'>
                ...
                <div className='w-1/2 h-full bg-[#FEF9C3] cinzel font-semibold uppercase py-[8%] px-20'>
